...
public class QuarryTile extends TileEntity implements ITickableTileEntity {

    public int x, y, z, tick;
    boolean initialized = false;

    public QuarryTile(final TileEntityType<?> tileEntityTypeIn) {
        super(tileEntityTypeIn);
    }

    public QuarryTile() {
        this(RegistryHandler.QUARRY_TILE.get());
    }
